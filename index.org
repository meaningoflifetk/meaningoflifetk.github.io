...
<script>
    ...
    *  LEARN WHY DEFINING THESE VARIABLES IS IMPORTANT: https://disqus.com/admin/universalcode/#configuration-variables    */
    ...
    this.page.url = meaningoflifetk.github.io;  // Replace PAGE_URL with your page's canonical URL variable
    this.page.identifier = index.html; // Replace PAGE_IDENTIFIER with your page's unique identifier variable
    };
    */
    (function() { // DON'T EDIT BELOW THIS LINE
    var d = document, s = d.createElement('script');
    s.src = 'https://meaning-of-life.disqus.com/embed.js';
...
<script id="dsq-count-scr" src="//meaning-of-life.disqus.com/count.js" async></script>
#+end_export
